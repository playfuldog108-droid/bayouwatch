...
// ---------- minimal Google Maps stubs (avoids needing @types/google.maps) --
...
function sensorInfoContent(pin: SensorPin): string {
  ...
  return [
    `<div style="font-family:monospace;font-size:12px;color:#1a202c;padding:4px 2px;min-width:170px;line-height:1.6">`,
  ...
  useEffect(() => {
    ...
    loadMapsScript()
      .then(() => {
        ...
        // Sensor markers — color-coded by flood status
      ...
      .catch(err => console.error('[FloodMap] load error:', err))
